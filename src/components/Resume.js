...
import {Paper, Typography, Button, Divider, List, ListItem, ListItemSecondaryAction, Collapse } from '@material-ui/core';
        ...
        {/* style={{border: '1px solid black'}} */} 
          ...
          <Divider variant="fullWidth" style={{ backgroundColor: '#000' }} /> 
            ...
            <List type="ordered"  style={{ paddingTop: 0 }}>
              <ListItem style={{ paddingBottom: 0 }}><strong>Weather Site</strong></ListItem>
