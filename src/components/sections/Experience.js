    ...
    <div>
      <Typography align="left" variant="h5"><strong>Experience</strong></Typography>
        ...
        <List type="ordered" style={{ paddingTop: 0 }}>
          ...
          <ListItem style={{ paddingTop: 0, marginLeft: '1em', paddingBottom: 0 }}>• Conceptualized and redesigned the Opine web application using responsive UI elements(Material UI) and React framework</ListItem>
